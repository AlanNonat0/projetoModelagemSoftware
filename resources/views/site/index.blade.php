    ...
    <div class="container-fluid">
        ...
        <div id="carouselReceitas" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-indicators">
                <button type="button" data-bs-target="#carouselReceitas" data-bs-slide-to="0" class="active"
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div
                        style="min-width: 100%; height: 400px; background-image: url({{ asset('img/slider/bolo.jpg', true) }}); background-size: cover; background-position:left">
                    </div>
                ...
                <div class="carousel-item">
                    <div
                        style="min-width: 100%; height: 400px; background-image: url({{ asset('img/slider/receita.jpg', true) }}); background-size: cover; background-position:left">
                    </div>
                ...
                <div class="carousel-item">
                    <div
                        style="min-width: 100%; height: 400px; background-image: url({{ asset('img/slider/macarrao.jpg', true) }}); background-size: cover; background-position:left">
                    </div>
                    <div class="carousel-caption ">
        ...
        <div class="mt-4"
            style="min-width: 100%; height: 200px; background-image: url({{ asset('img/slider/tempero-2.jpg', true) }}); background-size: cover; background-position:left">
        </div>
